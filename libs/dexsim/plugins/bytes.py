...
class BYTES(Plugin):
    ...
    def run(self):
        ...
        self.__process_new_string_func_return_bytes()
    ...
    def __process_new_string_func_return_bytes(self):

        '''
            参数是字符串，返回值是byte数组，但是，被new string包含：new String(decode2bytes('encoding string'))

            const-string v3, "aHR0cDovL2FuZHJvaWQuZXZpbHFpbi5jb20vbXlkb3duLnBocA=="

            invoke-static {v3}, Landroid/procss/phone/c;->a(Ljava/lang/String;)[B
    ...
    def __process_bytes(self):
        '''
            ...
            invoke-static {v0}, Lcom/google/rp/confirm/MyService;->a([B)Ljava/lang/String;

            move-result-object v0
        '''
        pass

    def ____process_aput_bytes(self):
            '''
                const/16 v0, 0x13
                ...
                直接转换成bytes数组，new byte[]{0x1, 0x2}，替换对应的参数
    ...
    def ____process_bytes_array1(self):
        '''
            const/4 v0, 0x5
            new-array v0, v0, [B
            fill-array-data v0, :array_720
            sput-object v0, Lcom/a/e/b;->O:[B

            sget-object v1, Lcom/a/e/b;->O:[B 不应该再set了，应该直接将这些数据写入odt，直接解密即可。
        '''
        pass
