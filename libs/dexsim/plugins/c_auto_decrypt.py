...
from ..otime import timeout, TIMEOUT_EXCEPTION
...
class ANY_MATCH(Plugin):
    '''
    自动匹配解密插件

    用于匹配那些比较麻烦的解密方法，相对比较耗时
    '''
    name = "ANY_MATCH"
    enabled = False
    tname = None
    ...
    def proccess(self):
        line_ptn = r'invoke-static.*?{([v\.\d,\s]*)}, (.*?);->(.*?)\(((?:B|S|C|I|J|F|D|Ljava/lang/String;)*?)\)Ljava/lang/String;'
        prog_line = re.compile(line_ptn)
        proto_ptn = r'(B|S|C|I|J|F|D|Ljava/lang/String;)'
